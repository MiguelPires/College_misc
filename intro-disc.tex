...
Section~\ref{sec:protocol} presents the Generalized Paxos protocol that is resilient against Byzantine failures while Appendix~\ref{app:cft} contains the corresponding
crash (but not Byzantine) tolerant protocol. Section~\ref{sec:disc} discusses some optimizations and concludes the paper.
