...
\begin{algorithm} 
	...
	\begin{algorithmic}[1]
		...
		\State		
		\State \textbf{upon} \textit{receive(VERIFICATION,ballot)} from learner l \textbf{do}
		\State \hspace{\algorithmicindent}\hspace{\algorithmicindent} \Call{send}{$VERIFICATION,ballot, val_a[ballot]$};	
