...
\begin{algorithm} 
	...
	\begin{algorithmic}[1]
		...
		\State\hspace{\algorithmicindent}\hspace{\algorithmicindent} $new\_view[view+1][p] = true$;
		\State\hspace{\algorithmicindent}\hspace{\algorithmicindent} \Call{send}{$VIEW\_CHANGE, view+1, suspicions$};
		\State
		
		\State\textbf{upon} \textit{receive($VIEW\_CHANGE, new\_view_i, suspicions$)} from acceptor $i$ \textbf{do} 
		...
		\State
		\State\hspace{\algorithmicindent} $new\_view[new\_view_i][i] = true$;
		\State\hspace{\algorithmicindent} \textbf{if} $new\_view[view_i][a] = \bot$ \textbf{then}
		\State\hspace{\algorithmicindent}\hspace{\algorithmicindent} $new\_view[view_i][a] = true$;
		\State\hspace{\algorithmicindent}\hspace{\algorithmicindent}  \Call{send}{$VIEW\_CHANGE, view_i, suspicions$};
		\State
