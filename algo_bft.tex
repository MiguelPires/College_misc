...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State \hspace{\algorithmicindent} \textbf{if} $m = ballot_l$ and \Call{verifySignatures}{$digest_{\sigma_p}$} \textbf{then}
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\If {$ballot \geq k$ and \Call{verifySignatures}{$digest_{\sigma_l}$}}
		\State $val_a = value$;
