...
\address{%
$^{1}$ \quad INESC-ID and Instituto Superior Técnico, R. Alves Redol 9, 1000-029 Lisbon, Portugal; rodrigo.miragaia.rodrigues@tecnico.ulisboa.pt\\ %Please confirm if it should use full word.
...
\corres{Correspondence: miguel.pires@tecnico.ulisboa.pt; Tel.: +351\hl{-}213100300}
...
\newblock In \emph{Distributed Algorithms, Proceedings of the 11th Workshop on Distributed Algorithms, Saarbrücken, Germany, 24--26 September 1997}; Springer: \hl{\mbox{Berlin/Heidelberg, Germany}}, %Newly added information, please confirm.
1997; \hl{LNCS 1320}. %Please confirm what it is and please confirm it is correct.
...
Nakamoto, S.
\newblock \hl{Bitcoin: A Peer-to-Peer Electronic Cash System. 2008}. %Please add more information to confirm its type, and please use correct format.
...
\newblock Microsoft ResearchTechnical Report MSR-TR-2005-33; \hl{2005}. %Please add publisher's name and location.
...
\hl{2012}.%Please add publisher's name and location.

\bibitem[Cachin \em{et~al.}(2011)Cachin, Guerraoui, and~Rodrigues]{cgr:book}
Cachin, C.; Guerraoui, R.; Rodrigues, L.E.T.
\newblock {\em Introduction to Reliable and Secure Distributed Programming}, 2nd~ed.; Springer: \hl{\mbox{Berlin/Heidelberg, Germany}}, 2011.
%Newly added information, please confirm.

\bibitem[Lamport(1998)]{Lamport:1998}
\hl{Lamport, L.} %This reference is the same as Ref 2 (\bibitem[Lamport(1998)]{Lam98}), please confirm and give modification.
\newblock The Part-time Parliament.
...
\newblock {Causal memory: Definitions, implementation, and~programming}. \hl{In \emph{Distributed Computing}; Springer: \mbox{Berlin/Heidelberg, Germany}}, 
