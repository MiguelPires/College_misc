...
import pt.tecnico.handler.ClientHandler;
...
public class FrontEndSDStore {
    ...
    public List<String> listDocs(String name) throws UserDoesNotExist_Exception, InvalidArgument_Exception, UnauthorizedOperation_Exception {
    ...
    public void createDoc(DocUserPair docUserPair) throws DocAlreadyExists_Exception, InvalidArgument_Exception, UnauthorizedOperation_Exception {
    ...
    public void sendToHandler(SDStore port, String[] tag){
        ...
        requestContext.put(ClientHandler.TYPE, "SDSTORE");
    }
