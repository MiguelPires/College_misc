...
\begin{table}[h!]
	...
	\begin{tabularx}{\linewidth}{ |c|X|}
		...
		\hline
		$acc\_send(x,s)$ & At least $x$ acceptors have sent verification messages for the sequence $s$ \\
		\hline
