...
\parbox{\linewidth}{2. At any given instant, $learned(l_j,learned_i) \land learned(l_i,learned_j) \implies learned_i \thicksim learned_j \bullet \sigma_1 \lor learned_j' \thicksim learned_i \bullet \sigma_2, \forall l_i,l_j \in \mathcal{L}$}\par
