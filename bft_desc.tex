...
\iffalse If the learner witnesses a sequence starting with a command $C^*$ and that command isn't in the first position of its $learned$ sequence, then it's able to deduce that some sequence containing $C^*$ is missing. \fi\par
