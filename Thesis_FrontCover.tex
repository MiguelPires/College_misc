...
\vspace{1.0cm}
{\FontLb Generalized Paxos Made Byzantine (and Less Complex)} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
...
{\FontSn %
\begin{tabular}{c}
\coverChairperson:     To be defined          \\ % <<<<< EDIT NAME
\coverSupervisor:      Prof. Rodrigo Miragaia Rodrigues \\ % <<<<< EDIT NAME
\coverMemberCommittee: Prof. Alysson Neves Bessani           % <<<<< EDIT NAME
\end{tabular} } \\
\vspace{1.5cm}
