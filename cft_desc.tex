...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State \hspace{\algorithmicindent} \textbf{else if} $\Call{isUniversallyCommutative}{value} $ and $\#(messages[ballot][value]) > f$ \State \hspace{\algorithmicindent}\hspace{\algorithmicindent} $learned = learned \bullet value$;
	\end{algorithmic}
\end{algorithm}
...
{\color{red} Will almost never happen}
...
{\color{red} If the previous extension doesn't hold much validity neither does this discussion}
