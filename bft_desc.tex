...
Protocol (or BGP, for short). This description includes both modifications due to the simplification of the generalized consensus problem and its extension to the Byzantine model.
\subsection{Overview}
