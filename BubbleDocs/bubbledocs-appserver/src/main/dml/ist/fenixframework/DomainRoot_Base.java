...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    ...
    public final static pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.tecnico.bubbledocs.domain.Bubbledocs> role$$bubbledocs = new pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.tecnico.bubbledocs.domain.Bubbledocs>() {
        @Override
        public pt.tecnico.bubbledocs.domain.Bubbledocs getValue(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base.DO_State)o1.get$obj$state(false)).bubbledocs;
        }
        @Override
        public void setValue(pt.ist.fenixframework.DomainRoot o1, pt.tecnico.bubbledocs.domain.Bubbledocs o2) {
            ((DomainRoot_Base.DO_State)o1.get$obj$state(true)).bubbledocs = o2;
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.tecnico.bubbledocs.domain.Bubbledocs,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.tecnico.bubbledocs.domain.Bubbledocs.role$$root;
        }
    ...
    private final static class DomainRootHasBubbleApplication {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.bubbledocs.domain.Bubbledocs> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.bubbledocs.domain.Bubbledocs>(role$$bubbledocs, "DomainRootHasBubbleApplication");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.bubbledocs.domain.Bubbledocs> getRelationDomainRootHasBubbleApplication() {
        return DomainRootHasBubbleApplication.relation;
    }
    
    static {
        DomainRootHasBubbleApplication.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasBubbleApplication");
    }
    ...
    public pt.tecnico.bubbledocs.domain.Bubbledocs getBubbledocs() {
        return ((DO_State)this.get$obj$state(false)).bubbledocs;
    }
    
    public void setBubbledocs(pt.tecnico.bubbledocs.domain.Bubbledocs bubbledocs) {
        getRelationDomainRootHasBubbleApplication().add((pt.ist.fenixframework.DomainRoot)this, bubbledocs);
    }
    
    private java.lang.Long get$oidBubbledocs() {
        pt.ist.fenixframework.backend.jvstmojb.pstm.AbstractDomainObject value = (pt.ist.fenixframework.backend.jvstmojb.pstm.AbstractDomainObject) ((DO_State)this.get$obj$state(false)).bubbledocs;
        return (value == null) ? null : value.getOid();
    }
    ...
    protected void checkDisconnected() {
        ...
        if (castedState.bubbledocs != null) handleAttemptToDeleteConnectedObject("Bubbledocs");
    ...
    protected void readStateFromResultSet(java.sql.ResultSet rs, pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject.DO_State  state) throws java.sql.SQLException {
        ...
        castedState.bubbledocs = pt.ist.fenixframework.backend.jvstmojb.repository.ResultSetReader.readDomainObject(rs, "OID_BUBBLEDOCS");
    }
    ...
    protected static class DO_State extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject.DO_State {
        ...
        private pt.tecnico.bubbledocs.domain.Bubbledocs bubbledocs;
        protected void copyTo(pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject.DO_State  newState) {
            ...
            newCasted.bubbledocs = this.bubbledocs;
