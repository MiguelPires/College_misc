...
\begin{algorithm} 
	...
	\begin{algorithmic}[1]
		...
		\If {$bal_a < ballot$}
		\State \Call{send}{$P1B, ballot,bal_a,proven, val_a, proofs[bal_a]$} to leader;
		\State $bal_a = ballot$;	
		\EndIf
		\EndFunction
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]			
		...
		\parbox{\linewidth}{\textbf{if} $\#(messages[ballot][value]) \geq N-f$ \textbf{then}}
