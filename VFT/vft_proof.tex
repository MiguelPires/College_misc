...
\indent\indent\indent\indent\indent\indent\parbox{\linewidth}{\strut\textbf{Proof:}}
...
\indent\indent\indent\indent\indent\indent\parbox{\linewidth}{\strut\textbf{Proof:}}
\indent\indent\indent\indent(...) \textcolor{red}{Continue here}
...
\indent\indent\indent\indent\indent\indent\parbox{\linewidth-\algorithmicindent*6}{\strut\textbf{Proof:} Since $s$ and $s'$ are non-commutative, therefore not equivalent, and each correct acceptor only votes once for a new proposal (Algorithm \ref{VFT-Acc}, lines \{27-39\}), any learner will only obtain either $N-s$ or $N-u$ votes for one of the sequences (Algorithm \ref{VFT-Learn}, lines \{1-8\}).}\par
