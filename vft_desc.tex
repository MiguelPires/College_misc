...
{\color{red} Talk about weak consistency and universally commutative commands. Mention how the parameterizability of the Visigoth model further increases BGP/VGPs potential in systems that function in geo-replicated scenarios}