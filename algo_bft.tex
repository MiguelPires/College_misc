...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State\hspace{\algorithmicindent}\hspace{\algorithmicindent} \Call{send}{$verification, bal, val$} to learners;
		...
		\State \hspace{\algorithmicindent}\hspace{\algorithmicindent} \hspace{\algorithmicindent} \Call{send}{$acknowledgment, bal_a, val_a$} to learners;
