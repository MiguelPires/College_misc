...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State \hspace{\algorithmicindent}\hspace{\algorithmicindent} \textbf{if} $\langle ballot, value \rangle = proof_{pub_a}$ \textbf{then}
		\State \hspace{\algorithmicindent}\hspace{\algorithmicindent}\hspace{\algorithmicindent} $messages[bal][a] = value$;
		\State \hspace{\algorithmicindent} \textbf{end for}
		\State
		\State \hspace{\algorithmicindent} \textbf{if} $\#(messages[bal]) \geq N-F$ \textbf{then}
