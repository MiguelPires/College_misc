...
\begin{abstract}
%
One of the most recent members of the Paxos family of protocols is generalized Paxos. 
...
However, much like the original Paxos counterpart, Generalized Paxos has by no means neither a simple specification, nor a simple implementation. 
